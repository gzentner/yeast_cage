...
plot_heatmap(exp, data_type = "tss", samples = "ScerYPD.1", threshold = 10, 
             ...
             upstream = 1000, downstream = 1000, max_value = 8) +
  theme(text = element_text(color = "black"))
```
...
plot_sequence_logo(
  exp, dominant = TRUE, samples = "ScerYPD.1", data_conditions = conditionals(
    data_quantiling = quantiling(score, 5), data_filters = iqr_width > 10))
```
...
plot_dinucleotide_frequencies(exp, samples = "ScerYPD.1", dominant = TRUE, threshold = 10,
                              data_conditions = conditionals(data_filters = iqr_width > 10)) +
